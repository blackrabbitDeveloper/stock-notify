...
현재 전략의 과거 성과를 검증할 수 있는 백테스터가 포함되어 있습니다.
...
### GitHub Actions 자동 백테스트
매주 토요일 자동으로 백테스트를 실행하고 Discord로 결과를 전송합니다.
GitHub Actions > `backtest-weekly` 워크플로우에서 수동 실행도 가능합니다.
